...
from models.moving_mnist_model import Generator
...
zeros = torch.zeros(100, 3, 1, 1, device=device)
...
idx2 = np.arange(10).repeat(10)

dis_c = torch.zeros(100, 20, 1, 1, device=device)
dis_c[torch.arange(0, 100), idx] = 1.0
dis_c[torch.arange(0, 100), 10+idx2] = 1.0
...
plt.savefig('generated_img1.png')
...
plt.savefig('generated_img2.png')