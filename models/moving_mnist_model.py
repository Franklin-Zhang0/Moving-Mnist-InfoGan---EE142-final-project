...
class Generator(nn.Module):
    def __init__(self, params):
        super().__init__()
        latent_dim = params['num_z'] + params['num_dis_c']*params['dis_c_dim'] + params['num_con_c']
        self.tconv1 = nn.ConvTranspose2d(latent_dim, 1024, 1, 1, bias=False)
...
class QHead(nn.Module):
    def __init__(self, params):
        super().__init__()
        num_dis_c = params['num_dis_c']*params['dis_c_dim']
        num_con_c = params['num_con_c']
        
        self.conv1 = nn.Conv2d(1024, 128, 1, bias=False)
        self.bn1 = nn.BatchNorm2d(128)

        self.conv_disc = nn.Conv2d(128, num_dis_c, 1)
